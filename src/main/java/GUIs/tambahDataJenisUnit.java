 ...
 */
public class tambahDataJenisUnit extends javax.swing.JFrame {

   jenisMetricRepo jenisMetricRepo = new jenisMetricRepo();
   JenisMetric jenisMetric;
    /**
     * Creates new form tambahDataJenisUnit
     */
    public tambahDataJenisUnit() {
        initComponents();
                ...
                .addGroup(panelAddBahanLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(panelAddBahanLayout.createSequentialGroup()
                        .addGroup(panelAddBahanLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(namaMetricField, javax.swing.GroupLayout.PREFERRED_SIZE, 420, javax.swing.GroupLayout.PREFERRED_SIZE)
            ...
            .addGroup(panelAddBahanLayout.createSequentialGroup()
                ...
                .addGroup(panelAddBahanLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(panelAddBahanLayout.createSequentialGroup()
                        ...
                        .addComponent(namaMetricField, javax.swing.GroupLayout.PREFERRED_SIZE, 37, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(33, 33, 33)
                        .addComponent(ket)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
 ...
 public JenisMetric getAllDataMetricField(){
       ...
       String keterangan = keteranganFields.getText();
       String namaMetric = namaMetricField.getText();
    
    
        return new JenisMetric(namaMetric,keterangan);
}
    private void tambahBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tambahBtnActionPerformed
        // TODO add your handling code here:
        jenisMetric = getAllDataMetricField();
        jenisMetricRepo.addJenisMetric(jenisMetric);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(tambahDataJenisUnit.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new tambahDataJenisUnit().setVisible(true);
            }
        });
    }
